...
export AZURACAST_VERSION=0.12.4
...
setup-release() {
  if [[ ! -f .env ]]; then
    ...
    curl -fsSL https://raw.githubusercontent.com/AzuraCast/AzuraCast/$AZURACAST_VERSION/sample.env -o .env
  fi
...
install() {
  ...
  if [[ ! -f azuracast.env ]]; then
    ...
    curl -fsSL https://raw.githubusercontent.com/AzuraCast/AzuraCast/$AZURACAST_VERSION/azuracast.sample.env -o azuracast.env
  ...
  if [[ ! -f docker-compose.yml ]]; then
    ...
    # else
    curl -fsSL https://raw.githubusercontent.com/AzuraCast/AzuraCast/$AZURACAST_VERSION/docker-compose.sample.yml -o docker-compose.yml
    # fi
  fi
